...
<body class="body-admin" id="bodyid">
	...
	<div class="titulo-panel">
		<h1 style="padding-top: 20vh;">PANEL DE ADMINISTRACIÓN</h1>
	</div>
		...
		<div class="row">
			...
			<div class="recuadros">
				...
				<div class="recuadro_left-admin hvr-admin">
						  <button type="button" class="btn btn-primary btn-lg boton-admin" data-toggle="modal" data-target="#ModalUsuarios" onclick="consultar(1)">USUARIOS</button>
				</div>
			      ...
			      <div class="modal-dialog modal-lg" role="document">
			        <div class="modal-content">
			          <div class="modal-header text-center">
			            <h4 class="modal-title w-100 font-weight-bold">Administracion de usuarios</h4>
				...
				<div class="recuadro_center-admin hvr-admin">
						  <button type="button" class="btn btn-primary btn-lg boton-admin" data-toggle="modal" data-target="#ModalCursas" onclick="consultar(2)">CURSAS</button>
				</div>
				...
				<div class="modal fade" id="ModalCursas" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"aria-hidden="true">
			      <div class="modal-dialog modal-lg" role="document">
			        <div class="modal-content">
			          <div class="modal-header text-center">
			            <h4 class="modal-title w-100 font-weight-bold">Administracion de Cursas</h4>
			            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
			              <span aria-hidden="true">&times;</span>
			            </button>
			          </div>
				...
				<div class="recuadro_right-admin hvr-admin">
						  <button type="button" class="btn btn-primary btn-lg boton-admin" data-toggle="modal" data-target="#ModalParticipantes" onclick="consultar(3)">PARTICIPANTES</button>
				</div>
				...
				<div class="modal fade" id="ModalParticipantes" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"aria-hidden="true">
			      <div class="modal-dialog modal-lg" role="document">
			        <div class="modal-content">
			          <div class="modal-header text-center">
			            <h4 class="modal-title w-100 font-weight-bold">Administracion de Participantes</h4>
			            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
			              <span aria-hidden="true">&times;</span>
			            </button>
			          </div>
			    ...
			    <div class="recuadro_cat-admin hvr-admin">
						  <button type="button" class="btn btn-primary btn-lg boton-admin" data-toggle="modal" data-target="#ModalCategorias" onclick="consultar(4)">CATEGORIAS</button>
				</div>
				...
				<div class="modal fade" id="ModalCategorias" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"aria-hidden="true">
			      <div class="modal-dialog modal-lg" role="document">
			        <div class="modal-content">
			          <div class="modal-header text-center">
			            <h4 class="modal-title w-100 font-weight-bold">Administracion de Categorias</h4>
			            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
			              <span aria-hidden="true">&times;</span>
			            </button>
			          </div>
	...
	<div class="container-fluid footer">
		<div class="row">
			<div class="col-md-4">
				<p class="txt-footer">Location<br>Passeig Sant Gervasi, 27, 08022 Barcelona<br>Contact<br>Tel: +34 93 415 98 65</p>
			</div>
			...
			<div class="col-md-4">
				<p class="txt-footer">Aviso Legal</p>
				<p class="txt-footer">Política de cookies</p>
				<p class="txt-footer">Política de privacidad</p>
			</div>
		</div>
	</div>
	<!--Footer-->
